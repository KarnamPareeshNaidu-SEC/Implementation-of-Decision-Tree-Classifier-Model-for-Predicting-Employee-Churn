...
2. Separate the input features (employee details) and target variable (churn status).
3. Split the dataset into training and testing sets using train_test_split().
4. Create the Decision Tree Classifier model using DecisionTreeClassifier().
5. Train the model using the training data and predict churn status for test data.
...
## Output:
<img width="903" height="357" alt="image" src="https://github.com/user-attachments/assets/d3429d43-1f45-4236-9b95-bfa5904313a1" />

<img width="1377" height="638" alt="image" src="https://github.com/user-attachments/assets/1e14e727-2d5c-4ffe-8fd5-9c114c28b491" />
